    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(verbose_name=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie_name_en', models.CharField(max_length=50, null=True)),
                ('movie_name_ry', models.CharField(max_length=50, null=True)),
                ('movie_name_tr', models.CharField(max_length=50, null=True)),
                ...
                ('description_ry', models.TextField(blank=True, null=True)),
                ...
                ('actor', models.ManyToManyField(to='kino_store.actor')),
                ('country', models.ManyToManyField(to='kino_store.country')),
                ('director', models.ManyToManyField(to='kino_store.director')),
                ('janre', models.ManyToManyField(to='kino_store.janre')),
            ],
        ),
        migrations.CreateModel(
            name='Moments',
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kino_store.movie')),
            ],
        ),
        migrations.CreateModel(
            name='History',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kino_store.favorite')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kino_store.movie')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='kino_store.movie')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='relies', to='kino_store.rating')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
